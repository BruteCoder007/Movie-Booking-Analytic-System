...
export default function Collectionbasedongenres(){
    const[results,setresult]=React.useState([]);
    const Datafetch=async ()=>{
    const res=await axios.post("http://localhost:5000/Aggregate/totalrevenuebasedongenre")
    ...
    return(<div>
     <Header text='Total Revenue based on genres' classname='header'/>
