...
export default function Collectionineverytheatre(){
    const[results,setresult]=React.useState([]);
    const Datafetch=async ()=>{
    const res=await axios.post("http://localhost:5000/Aggregate/totalcollectionintheatre")
    ...
    return(<div>
     <Header text='Total Revenue in every theatres' classname='header'/>
